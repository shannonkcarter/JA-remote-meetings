        ...
        div(class="main-input-section",
            ...
            div(
                ...
                orderInput(
                    inputId = 'people',
                    label = 'Meeting Order: ',
                    items = c('Brian', 'Carly', 'David', "Divia", "Emi", "Gerard", "Jeff", "Jessica", "Kelsey", "Kevin", "Shannon", "Smith"),
        ...
        div(
            ...
            div(
              wellPanel(
                ...
                div(class="indv-written-stats",
                    ...
                    h5(paste0("Most likely to be called on by: ", stats$called_on_by_most[stats$name == "Jessica"], " (", stats$called_on_by_x_pct[stats$name == "Jessica"], "%)"), align = "left"),
                ),
                div(class="recent-activity",
                    h5("Recent activity"),
                    plotOutput("colors_jessica", height = "100%")
                )
              )
            ),
            ...
            div(
              wellPanel(
                ...
                img(src = "ja.png", class="profile-img", height = 150),
                plotOutput("hist_kevin", height = "100%", width= '70%'),
                div(class="indv-written-stats",
                    h5(paste0("Most often goes: ", stats$mode_pretty[stats$name == "Kevin"]),  align = "left"),
                    h5(paste0("Most likely to call on: ", stats$calls_on_most[stats$name == "Kevin"], " (", stats$called_on_x_pct[stats$name == "Kevin"], "%)"), align = "left"),
                    h5(paste0("Most likely to be called on by: ", stats$called_on_by_most[stats$name == "Kevin"], " (", stats$called_on_by_x_pct[stats$name == "Kevin"], "%)"), align = "left"),
                ),
                div(class="recent-activity",
                    h5("Recent activity"),
                    plotOutput("colors_kevin", height = "100%")
                )
              )
            ),
