        ...
        div(class="main-input-section",
            ...
            div(
                ...
                orderInput(
                    inputId = 'people',
                    label = 'Meeting Order: ',
                    items = c("Adelle", 'Carly', 'David', "Divia", "Gerard", "Jeff", "Jonathan", "Juweek", "Kaitlin", "Katie", "Kelsey", "Marian", "Shannon"),
        ...
        div(
            ...
            div(
              wellPanel(
                ...
                #img(src = "jeff.jpg", class="profile-img", height = 150),
                plotOutput("hist_jonathan", height = "100%", width= '70%'),
                div(class="indv-written-stats",
                    h5(paste0("Most often goes: ", stats$mode_pretty[stats$name == "Jonathan"]),  align = "left"),
                    h5(paste0("Most likely to call on: ", stats$calls_on_most[stats$name == "Jonathan"], " (", stats$called_on_x_pct[stats$name == "Jonathan"], "%)"), align = "left"),
                    h5(paste0("Most likely to be called on by: ", stats$called_on_by_most[stats$name == "Jonathan"], " (", stats$called_on_by_x_pct[stats$name == "Jonathan"], "%)"), align = "left"),
                ),
                div(class="recent-activity",
                    h5("Recent activity"),
                    plotOutput("colors_jonathan", height = "100%")
                )
              )
            ),
            ...
            div(
              wellPanel(
                ...
                #img(src = "gpt.jpg", class="profile-img", height = 150),
                plotOutput("hist_kaitlin", height = "100%", width= '70%'),
                div(class="indv-written-stats",
                    h5(paste0("Most often goes: ", stats$mode_pretty[stats$name == "Kaitlin"]),  align = "left"),
                    h5(paste0("Most likely to call on: ", stats$calls_on_most[stats$name == "Kaitlin"], " (", stats$called_on_x_pct[stats$name == "Kaitlin"], "%)"), align = "left"),
                    h5(paste0("Most likely to be called on by: ", stats$called_on_by_most[stats$name == "Kaitlin"], " (", stats$called_on_by_x_pct[stats$name == "Kaitlin"], "%)"), align = "left"),
                ),
                div(class="recent-activity",
                    h5("Recent activity"),
                    plotOutput("colors_kaitlin", height = "100%")
                )
              )
            ),
